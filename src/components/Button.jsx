...
const variants = {
  ...
  yellow:
    "border border-neon-yellow text-neon-yellow hover:bg-neon-yellow hover:text-void-900 shadow-neon-yellow hover:shadow-[0_0_20px_#ffbe0b]",
  green:
    "border border-neon-green text-neon-green hover:bg-neon-green hover:text-void-900 shadow-neon-green",
  ghost: "border border-white/50 text-white/550 hover:border-white/70 hover:text-white/80",
};
